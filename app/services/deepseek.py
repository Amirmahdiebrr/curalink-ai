...
# قبلاً ۸۱۹۲ بود؛ برای آزمایش‌هایی با تعداد پارامتر بالا، مجموع متن
# روایی گزارش + بلوک JSON انتهایی از این مقدار بیشتر می‌شد و پاسخ
# مدل وسط بلوک JSON قطع می‌شد.
MAX_TOKENS = 16000
