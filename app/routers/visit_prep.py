...
Generates a doctor-visit preparation summary for the logged-in user
or one of their family members, based on aggregated lab test history
and an optional visit reason, and saves it to history.
"""
...
async def visit_prep_generate(
    ...
    reason_value = (visit_reason or "").strip()[:MAX_REASON_LENGTH]
